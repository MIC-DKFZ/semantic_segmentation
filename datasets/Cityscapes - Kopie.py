...
if __name__ == "__main__":
    dataset_path="/home/l727r/Desktop/endocv2022/official EndoCV2022 dataset/EndoCV2022_ChallengeDataset/PolypGen2.0/*/masks/*"
    #"F:\Desktop\endocv2022\official EndoCV2022 dataset\EndoCV2022_ChallengeDataset\PolypGen2.0"
    seq=glob.glob(dataset_path)
    print(len(seq))

    dataset_path = "/home/l727r/Desktop/endocv2022/official EndoCV2022 dataset/EndoCV2022_ChallengeDataset/PolypGen2.0/*/images/*"
    # "F:\Desktop\endocv2022\official EndoCV2022 dataset\EndoCV2022_ChallengeDataset\PolypGen2.0"
    seq = glob.glob(dataset_path)
    print(len(seq))
