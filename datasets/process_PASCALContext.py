...
mapping=np.array([  0,   2,   9,  18,  19,  22,  23,  25,  31,  33,  34,  44,  45,
...
root_path="../../Datasets/"
img_files=glob.glob(os.path.join(root_path,"VOCtrainval_03-May-2010","VOCdevkit","VOC2010","JPEGImages","*.jpg"))
print(len(img_files))
print(img_files[0])
max_w=0
max_h=0
...
with open(os.path.join(root_path,"VOCtrainval_03-May-2010","VOCdevkit","VOC2010","ImageSets","Main","train.txt")) as file:
    train = file.readlines()
    train = [line.rstrip() for line in train]
with open(os.path.join(root_path,"VOCtrainval_03-May-2010","VOCdevkit","VOC2010","ImageSets","Main","val.txt")) as file:
    val = file.readlines()
...
for file in tqdm(files):
    ...
    img_file=os.path.join(root_path,"VOCtrainval_03-May-2010","VOCdevkit","VOC2010","JPEGImages",id+".jpg")
