...
class LearningRateDecayOptimizerConstructor(DefaultOptimizerConstructor):
    ...
    def add_params(self, params, module, **kwargs):
        ...
        logger.info(
            f"Build LearningRateDecayOptimizerConstructor  {decay_type} {decay_rate} - {num_layers}"
        )
...
class LayerDecayOptimizerConstructor(LearningRateDecayOptimizerConstructor):
    ...
    def __init__(self, optimizer_cfg, paramwise_cfg):
        ...
        warnings.warn(
            "DeprecationWarning: Layer_decay_rate will be deleted, please use decay_rate instead."
        )
