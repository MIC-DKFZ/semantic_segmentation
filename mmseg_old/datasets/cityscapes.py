...
class CityscapesDataset(CustomDataset):
    ...
    def __init__(
        self, img_suffix="_leftImg8bit.png", seg_map_suffix="_gtFine_labelTrainIds.png", **kwargs
    ):
    ...
    def _evaluate_cityscapes(self, results, logger, imgfile_prefix):
        ...
        try:
            ...
            raise ImportError(
                'Please run "pip install cityscapesscripts" to install cityscapesscripts first.'
            )
