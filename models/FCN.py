...
def get_seg_model(
    ...
    """
    Initialize a FCN Model with a resnet backbone
    ...
    # load the fcn model with the corresponding backbone
    if backbone == "resnet101":
        model = fcn_resnet101(pretrained=pretrained, aux_loss=aux_loss, **kwargs)
    elif backbone == "resnet50":
        model = fcn_resnet50(pretrained=pretrained, aux_loss=aux_loss, **kwargs)
