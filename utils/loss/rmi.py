...
class weighted_RMILoss(RMILoss):
	def __init__(self,num_classes=21, rmi_radius=3, rmi_pool_way=0, rmi_pool_size=3,rmi_pool_stride=3, loss_weight_lambda=0.5, lambda_way=1, class_weights=None):
		super().__init__(num_classes,rmi_radius,rmi_pool_way, rmi_pool_size,rmi_pool_stride,loss_weight_lambda,lambda_way)
...
if __name__ == "__main__":
	loss=RMILoss()
	y=torch.rand((2,21,30,30))
	p=torch.rand((2,30,30))
	print(loss(y,p))