import torch
from utils.loss.rmi import RMILoss, weighted_RMILoss
...
def get_loss_function_from_cfg(LOSSFUNCTION, cfg):
    ...
    if LOSSFUNCTION == "CE":
        ...
        DC_and_CE = DC_and_CE_loss({'batch_dice': True, 'smooth': 0, 'do_bg': False},
        ...
        DC_TopK = DC_and_topk_loss({'batch_dice': True, 'smooth': 0, 'do_bg': False},
                                   {'ignore_index': ignore_index},
                                   ignore_label=ignore_index)
