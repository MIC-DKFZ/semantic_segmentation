...
## Experimental Stuff
class LR_Stepper():
    def __init__(self,epochs,gpus,acc_grad_batches,coarse_size,base_size,batch_size,start_portion,max_coarse_epoch):
...
def polynomial_LR_scheduler_coarse_step(optimizer,epochs,gpus,acc_grad_batches,coarse_size,base_size,batch_size,start_portion,max_coarse_epoch,**kwargs):
    lambda_class = LR_Stepper(epochs,gpus,acc_grad_batches,coarse_size,base_size,batch_size,start_portion,max_coarse_epoch)
